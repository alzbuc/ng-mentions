...
export declare class NgHighlighterPatternDirective implements OnInit, OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgHighlighterPatternDirective, "ng-highlighter-pattern", ["ngHighlighterPattern"], { "className": "className"; "markup": "markup"; "markupReplace": "markupReplace"; }, {}, never>;
}
