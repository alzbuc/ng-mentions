...
export class NgMentionsAccessorDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.7", ngImport: i0, type: NgMentionsAccessorDirective, deps: [{ token: i0.ElementRef }, { token: i1.NgMentionsComponent }], target: i0.ɵɵFactoryTarget.Directive });
